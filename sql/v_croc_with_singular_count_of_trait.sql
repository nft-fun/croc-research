create or replace view v_croc_with_singular_count_of_trait
...
WHERE v1c.percentage < 0.015
   OR v2c.percentage < 0.015
   OR v3c.percentage < 0.015
   OR v4c.percentage < 0.015
   OR v5c.percentage < 0.015
   OR v6c.percentage < 0.015
   OR v7c.percentage < 0.015
   OR v8c.percentage < 0.015
